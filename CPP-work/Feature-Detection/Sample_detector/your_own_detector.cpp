//Use the OpenCV function cv::cornerEigenValsAndVecs to find the eigenvaluesand eigenvectors to determine if a pixel is a corner.
...
int main(int argc, char** argv)
{
    ...
    src = imread("E:/workspace/WFH/imgg2.png");
    if (src.empty())
    {
